...
const Page = () => {
  ...
  const registerSchema = yup.object().shape({
    ...
    email: yup
      .string()
      .email("Invalid email format or email already exist")
  ...
  const onSubmitRegister = async (data) => {
    try {
      ...
      console.error(error);
      toast.error("email already exist or invalid email format");
    } finally {
      setIsLoading(false);
      resetSignUpForm();
    }
                ...
                <form onSubmit={handleSubmitLogin(onSubmitLogin)}>
                  <div className="space-y-4">
                    ...
                    <Button className="w-full" type="submit">
                      <LogIn className="mr-2 w-4 h-4" disabled={isLoading} />{" "}
                      Log in
                    </Button>
                  </div>
                </form>
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSubmitSignUp(onSubmitRegister)}>
                  <div className="space-y-4">
                    ...
                    <Button className="w-full" type="submit">
                      <Save className="mr-2 w-4 h-4" disabled={isLoading} />{" "}
                      Sign Up
                    </Button>
                  </div>
                </form>
